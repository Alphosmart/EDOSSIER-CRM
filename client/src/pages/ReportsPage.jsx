        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="card text-center">
              ...
              <p className="text-2xl font-bold text-primary-600">{formatNaira(salesReport.totalRevenue || 0)}</p>
            </div>
            <div className="card text-center">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="card text-center">
              ...
              <p className="text-2xl font-bold text-green-600">{formatNaira(commissionReport.totalCommission || 0)}</p>
            </div>
            <div className="card text-center">
              <p className="text-sm text-gray-500">Pending Payouts</p>
              <p className="text-2xl font-bold text-yellow-600">{formatNaira(commissionReport.pending || 0)}</p>
            </div>
            <div className="card text-center">
              <p className="text-sm text-gray-500">Paid Out</p>
              <p className="text-2xl font-bold text-primary-600">{formatNaira(commissionReport.paid || 0)}</p>
            </div>
          </div>
                  ...
                  <tbody className="divide-y">
                    {commissionReport.details.map((d, i) => (
                      <tr key={i} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3">{formatNaira(d.dealValue)}</td>
                        <td className="px-4 py-3">{d.rate}%</td>
                        <td className="px-4 py-3 font-bold text-green-600">{formatNaira(d.commission)}</td>
                  ...
                  <div key={i} className="card">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div>
                        ...
                        <span className="ml-2 font-bold text-green-600">{formatNaira(t.revenue || 0)}</span>
                      </div>
                      <div>
                        <span className="text-gray-500">Pipeline:</span>
                        <span className="ml-2 font-bold text-primary-600">{formatNaira(t.pipeline || 0)}</span>
                      </div>
                      <div>
