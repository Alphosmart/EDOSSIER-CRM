const nigerianStatesLgas = {
  ...
  "Delta": ["Aniocha North","Aniocha South","Bomadi","Burutu","Ethiope East","Ethiope West","Ika North East","Ika South","Isoko North","Isoko South","Ndokwa East","Ndokwa West","Okpe","Olomu","Patani","Sapele","Udu","Ughelli North","Ughelli South","Ukwuani","Uvwie","Warri North","Warri South","Warri South West"],
...
export const NIGERIAN_STATES = Object.keys(nigerianStatesLgas).sort();

export const getLgasByState = (state) => nigerianStatesLgas[state] || [];

export default nigerianStatesLgas;
