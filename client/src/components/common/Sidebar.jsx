...
const navItems = [
  ...
  { path: '/subscriptions', label: 'Subscriptions', icon: HiOutlineRefresh, roles: ['admin', 'manager', 'bursar', 'team_lead'] },
  { path: '/forecast', label: 'Forecast', icon: HiOutlineTrendingUp, roles: ['admin', 'manager', 'bursar', 'team_lead'] },
  { path: '/monthly-performance', label: 'Performance', icon: HiOutlineCalendar, roles: ['admin', 'manager', 'bursar'] },
  { path: '/reports', label: 'Reports', icon: HiOutlineChartBar, roles: ['admin', 'manager', 'bursar', 'team_lead'] },
